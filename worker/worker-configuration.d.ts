/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 55427ca648e04260006edd65bc58406d)
...
interface __BaseEnv_Env {
	...
	VB_API_KEY: string;
	VB_AGENT_ID: string;
	INGEST: DurableObjectNamespace<import("./src/index").IngestDO>;
	CALL: DurableObjectNamespace<import("./src/index").CallDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IngestDO" | "CallDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VB_API_KEY" | "VB_AGENT_ID">> {}
}
